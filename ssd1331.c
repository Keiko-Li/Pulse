...
#define SSD1331_PIN_SET		P6DIR |= BIT4; P6DIR |= BIT5; P6DIR |= BIT6

#define SSD1331_RES_SET()   P6OUT |= BIT4
#define SSD1331_RES_CLR()   P6OUT &=~BIT4
#define SSD1331_DC_SET()    P6OUT |= BIT5
#define SSD1331_DC_CLR()    P6OUT &=~BIT5
#define SSD1331_CS_SET()    P6OUT |= BIT6
#define SSD1331_CS_CLR()    P6OUT &=~BIT6
